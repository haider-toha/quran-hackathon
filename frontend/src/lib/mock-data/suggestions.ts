...
//
// Phase 2 note: `reason` strings are kept on the type for backward
// compatibility but the redesigned rail no longer renders them — the source
// label has taken over that role. We blank the field rather than deleting
// it so external callers and admin tooling don't break. Previews have been
// softened to remove corrective phrasings ("haven't cited", "you wrote
// about…") in favour of descriptive lines.
...
const N1: readonly Suggestion[] = [
  ...
  },
  {
    ...
    reason: "",
    preview:
      "As-Sadi uses tarbiyya here — nurturing rather than absence. A small reframe of the pause.",
    source: { name: "As-Sadi", ref: "93:3" },
    feedback: null,
  },
  {
    ...
    kind: "related-note",
    reason: "",
    preview: "“Reading ‘qala’ carefully” — your earlier note on the same word, in another season.",
    source: { name: "Past note", ref: "n6" },
    feedback: null,
  },
  {
  ...
  },
  {
    ...
    reason: "",
    preview:
      "Ibn Kathir reads waddaaka as a formal goodbye — negating it denies that any farewell occurred at all.",
    source: { name: "Ibn Kathir", ref: "93:3" },
    feedback: null,
  },
];
...
const N2: readonly Suggestion[] = [
  ...
  },
  {
    ...
    source: { name: "As-Sadi", ref: "93:6-8" },
    feedback: null,
  },
  {
...
const N3: readonly Suggestion[] = [
  ...
  },
  {
    ...
    source: { name: "Al-Qurtubi", ref: "93:8" },
    feedback: null,
  },
  {
...
const N4: readonly Suggestion[] = [
  ...
  },
  {
    ...
    kind: "tafsir-match",
    reason: "",
    preview: "As-Sadi reads duha and layl as opposites that both belong to the same hand.",
    source: { name: "As-Sadi", ref: "93:1-2" },
    feedback: null,
  },
  {
...
const N5: readonly Suggestion[] = [
  ...
  },
  {
    ...
    kind: "related-note",
    reason: "",
    preview: "“On grief that comes in waves” — an earlier reflection on dryness and tarbiyya.",
    source: { name: "Past note", ref: "n1" },
    feedback: null,
  },
  {
    ...
    reason: "",
    preview:
      "Al-Qurtubi gives fifteen days as the majority position; some narrate forty. The duration is contested.",
    source: { name: "Al-Qurtubi", ref: "93:1" },
    feedback: null,
  },
  {
...
const N6: readonly Suggestion[] = [
  ...
  },
  {
    ...
    reason: "",
    preview:
      "Ibn Kathir glosses qala as active dislike, not mere distance — the heat behind the verb.",
    source: { name: "Ibn Kathir", ref: "93:3" },
    feedback: null,
  },
  {
    ...
    reason: "",
    preview:
      "If even a flicker of qala is denied, what does that say about how to read the silences in prayer?",
    source: null,
    feedback: null,
  },
];
...
const N7: readonly Suggestion[] = [
  ...
  },
  {
    ...
    reason: "",
    preview:
      "As-Sadi notes that the gift in la-sawfa is left without a noun — the open-endedness is itself the gift.",
    source: { name: "As-Sadi", ref: "93:5" },
    feedback: null,
  },
  {
...
const N8: readonly Suggestion[] = [
  ...
  },
  {
    ...
    reason: "",
    preview:
      "“The orphan and the seeker” — an earlier reflection on the same three-finding pattern.",
    source: { name: "Past note", ref: "n2" },
    feedback: null,
  },
  {
...
const N9: readonly Suggestion[] = [
  ...
  },
  {
    ...
    source: { name: "At-Tabari (via al-Qurtubi)", ref: "93:5" },
    feedback: null,
  },
  {
...
const N10: readonly Suggestion[] = [
  ...
  },
  {
    ...
    reason: "",
    preview:
      "As-Sadi widens sail to include both the asker for wealth and the asker for knowledge.",
    source: { name: "As-Sadi", ref: "93:10" },
    feedback: null,
  },
  {
    id: "n10-prompt-tone",
    ...
    reason: "",
    preview:
      "Recall the last time you said no to a request. What was your tone, even when the answer was correct?",
    source: null,
    feedback: null,
  },
];
